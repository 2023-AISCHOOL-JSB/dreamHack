    ...
    this.setActiveTool = (id) => {
      ...
      switch (id) {
        case 'draw':
          ...
          this.updateTip('Tip : 화살표를 사용하여 선택한 개체를 1픽셀씩 이동!');
          break;
        case 'line':
          ...
          this.updateTip('Tip: 15 ° 각도 점프를 위해 선을 그릴 때 Shift를 잡으십시오!');
          break;
        case 'path':
          ...
          this.updateTip('Tip : 클릭하여 점을 배치하고, 커브를 길게 누르십시오! 취소하려면 외부를 클릭하거나 Esc를 클릭하십시오!');
          break;
        case 'textbox':
          ...
          this.updateTip('Tip : Tip : Ctrl +/-, Ctrl + 휠을 확대 / 축소합니다!');
          break;
        case 'upload':
          this.openDragDropPanel();
          break
        default:
          this.updateTip('Tip : Shift를 클릭하여 여러 개체를 선택하고 수정하십시오!');
          break;
      }
    }
